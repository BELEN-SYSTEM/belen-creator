@echo off
REM Intercepta "ninja -t clean" en Windows: si BelenCreator.exe esta en uso, ninja no puede borrarlo.
...
if not errorlevel 1 (
  echo [ninja_preclean] Cerrando BelenCreator.exe si bloquea el clean...
  taskkill /F /IM BelenCreator.exe 2>nul
